...
namespace Framework.LongestCommonString
{
    public static class Plsc
    {
        ...
        /// </summary>
        /// <param name="str1">string numéro 1 </param>
        /// <param name="str2">string numéro 2</param>
        /// <param name="sequence">séquence commune</param>
        /// <returns>nombre de lettre communes</returns>
